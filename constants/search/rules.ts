export default [
  ...
  },
  {
    ...
    category: ["GLOSSARY"],
    tags: [],
    desc: `There are seven factions in the game: Rebel (The Rebel Alliance), Imperial (The Galactic Empire), Scum (Scum and Villainy), Resistance, First Order, Republic (Grand Army of the Republic), and Separatist (Separatist Alliance).`,
  },
  {
    title: "FAIL",
    id: "Fail",
  ...
  },
  {
    ...
    category: ["GLOSSARY"],
    tags: [],
    desc: `During the game, each player calculates and tracks their mission points. The player with the most mission points at the end of the game wins.`,
  },
  {
