...
facing. This uses the same template as the <LeftBank/> and <RightBank/> maneuvers.
    + If the ship fully executes the maneuver, the player slides the ship's front
    guides into the end of the template instead of the rear guides.
* **Tallon Roll:** The <TallonLeft/> (left Tallon Roll) and <TallonRight/> (right Tallon Roll) bearings
    ...
    180º. This uses the same template as the <LeftTurn/> and <RightTurn/> maneuvers.
...
by 45º. This bearing uses the same template as the <LeftBank/> and <RightBank/> maneuvers.
