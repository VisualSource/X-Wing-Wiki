...
<ImgCenter
  src="/images/HUGE_SHIPS_DAMAGE_CARDS.webp"
  alt="Precision Shot Effect on Huge Ship Damage Card"
/>
...
<ImgCenter
  src="/images/HUGE_SHIPS_DEPLOY_SHIP.webp"
  alt="Huge Ship Deploying a Ship"
/>
...
<ImgCenter
  src="/images/HUGE_SHIP_MANEUVER_1.webp"
  alt="Final Postion for a right bank"
/>
<TextCenter>
...
<ImgCenter
  src="/images/HUGE_SHIP_MANEUVER_2.webp"
  alt="Final Postion for a 0 maneuver"
/>
<TextCenter>
...
- When a huge ship recovers
  <Energy /> or <Shield />, increase the relevant tracker by that amount, to a
  maximum of its energy or shield value, respectively.
...
<ImgCenter
  src="/images/Turret_Arc_Indicatiors_HS.webp"
  alt="Turret Arc Indicators"
/>
