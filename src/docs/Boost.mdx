...
any of the following occurs:
    + The ship's final positions would cause the ship to [overlap](/article/overlap) another ship.
    + The ship would overlap or [move through](/article/Move_Through) an [obstacle](/article/Obstacle).
