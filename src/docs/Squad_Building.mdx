<Header title="SQUAD BUILDING" />

[Faction](#faction "id") |
[Limited And Solitary Card](#limited-and-soitary-cards "id") |
[Ban List](#ban-list "id") |
[Restricted List](#restricted-list "id") |
[Squad Points](#squad-points "id") |
[Loadout Value](#loadout-value "id") |
[Builder Keywords](#builder-keywords "id") |
[Upgrades](#upgrades "id") |
[Loadout Points](#loadout-points "id")
...
list of all ship card squad point costs is available at [www.atomicmassgames.com/xwing-documents](http://www.atomicmassgames.com/xwing-documents"id").
...
value. A list of all ships' loadout values is available at [www.atomicmassgames.com/xwing-documents](http://www.atomicmassgames.com/xwing-documents"id").

## BUILDER KEYWORDS

Some ships have builder keywords. These keywords are required to equip
certain upgrades. A list of all ships' builder keywords is available at [www.atomicmassgames.com/xwing-documents](http://www.atomicmassgames.com/xwing-documents"id").
...
- Each ship has an upgrade bar, which is a list of upgrade icons that limit
  ...
  is available at [www.atomicmassgames.com/xwing-documents](http://www.atomicmassgames.com/xwing-documents"id").
...
modes. A list of all upgrade card loadout point costs is available at [www.atomicmassgames.com/xwing-documents](http://www.atomicmassgames.com/xwing-documents"id").
