<Header title="card Interpretation" version="1.4.4"/>
...
that says “At the start of the Engagement Phase, you may perform a <BarrelRoll/>
...
of those results. For example, if an ability refers to “2 <Hit/>/<Crit/> results” this
would include two <Hit/> results, two <Crit/> results, or one <Hit/> and one <Crit/> result.
