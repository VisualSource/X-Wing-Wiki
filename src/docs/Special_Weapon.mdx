...
the header.
    + The **“attack (<Lock/>):”** header indicates that the attacker must have a
    [lock](/article/Lock) on the defender.
    + The **“attack (<Focus/>):”** header indicates that the attacker must have a
