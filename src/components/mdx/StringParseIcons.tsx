...
export default function StringParseIcons(value: string, components: { [key: string]: any }) {
    const matches =  [...value.matchAll(/<(?<icon>[\w]+)\/>/g)];
    ...
    for(const match of matches) {
        ...
        if(!Icon) throw new TypeError(`Invaild icon name (${icon})`);
